<header>
    ...
    <a href="index.html" class="easion-logo"><i class="fas fa-sun"></i> <span>Punlork</span></a>
</header>
<nav class="dash-nav-list">
    ...
    <div class="dash-nav-dropdown">
        ...
        <div class="dash-nav-dropdown-menu">
            <a href="#" target="_blank" class="dash-nav-dropdown-item">GitHub</a>
            <a href="#" target="_blank" class="dash-nav-dropdown-item">UseBootstrap</a>
            <a href="#" target="_blank" class="dash-nav-dropdown-item">Jassa</a>
        </div>
    </div>
</nav>
